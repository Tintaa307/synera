        ...
        <section className="h-screen w-full antialiased flex items-center justify-center">
          ...
          >
            <div className="flex flex-col gap-2 xs:gap-0">
              <h1 className="w-full h-full text-7xl xxl:text-6xl md:lg:text-5xl sm:md:xxl:text-4xl ls:sm:md:xxl:text-3xl sm:xs:leading-10 font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
                {t("title")}
              </h1>
              <h1 className="w-full h-full text-7xl xxl:text-6xl md:lg:text-5xl sm:md:xxl:text-4xl ls:sm:md:xxl:text-3xl sm:xs:leading-10 font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
                {t("title2")}
